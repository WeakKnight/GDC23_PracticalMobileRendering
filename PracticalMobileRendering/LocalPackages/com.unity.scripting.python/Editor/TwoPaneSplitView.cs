...
namespace UnityEditor.UIElements
{
    internal class TwoPaneSplitView : VisualElement
    {
        ...
        private const float k_MinDimension = 100;
        ...
        public TwoPaneSplitView()
        {
            ...
            styleSheets.Add(AssetDatabase.LoadAssetAtPath<StyleSheet>("Packages/com.unity.scripting.python/Styles/TwoPaneSplitView.uss"));
        ...
        void PostDisplaySetup()
        {
            ...
            {
                if (m_FixedPaneIndex == 0)
                    m_DragLineAnchor.style.top = m_FixedPaneInitialDimension - 2;
                else
                    m_DragLineAnchor.style.top = this.resolvedStyle.height - m_FixedPaneInitialDimension + 2;
            }
            ...
            if (m_FixedPaneIndex == 0)
                m_Resizer = new SquareResizer(this, direction, k_MinDimension, m_Orientation, m_Buffer);
            else
                m_Resizer = new SquareResizer(this, direction, k_MinDimension, m_Orientation, m_Buffer);
        ...
        class SquareResizer : MouseManipulator
        {
            ...
            public void ApplyDelta(float delta)
            {
                ...
                // If needed, clamp the new dimension to the minimum allowed.
                ...
                // If needed, clamp the new dimension to the maximum allowed.
